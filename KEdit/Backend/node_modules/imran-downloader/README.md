...
<img alt="version" src="https://img.shields.io/github/package-json/v/MR-IMRAN-60/imran-media-downloader?label=github&style=flat-square">
<a href="https://www.npmjs.com/package/nayan-downloader"><img src="https://img.shields.io/npm/dm/imran-downloader.svg?style=flat-square" alt="npm downloads"></a>

## Instalation :
```bash
> npm i imran-downloader
```
